...
namespace Domain.Entities.WorkoutSession
{
    ...
    namespace Domain.Entities.WorkoutSession
    {
        public class WorkoutSessionExercise
        {
            ...
            public WorkoutSessionExercise(int workoutSessionId, string name, int targetSets, int targetReps, int restSeconds)
            {
            ...
            {
                _sets.Add(new WorkoutSessionSet(Id, setNumber));
            }
        }
    }
